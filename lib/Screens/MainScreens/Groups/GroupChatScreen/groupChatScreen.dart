    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                ...
                itemBuilder: (context, i) {
                  ...
                  return Stack(children: [
                    ChatBubbleContainer(
                      ...
                      seenSoFar: dummyData.messages[index]['viewedBy'],
                      dummyData: dummyData,
                      index: index,
          ...
          reactionUtil.ReactionKeyboardWidget((category, emoji) {
            setState(() {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    //TODO: user status
                    Text(
                      dummyData.participants.toString().substring(1, dummyData.participants.toString().length - 1),
              ...
              child: Row(
                children: [
                  IconButton(
                    ...
                    icon: Icon(
                      _isEmojiKeyboardVisible ? Icons.keyboard : Icons.emoji_emotions_rounded,
                  ...
                  !_isNotTyping
                      ...
                      : IconButton(
                          onPressed: () {
                            Get.to(() => CameraImagePickerScreen(), arguments: {
                              'pid': '',
                              'friendUid': '',
                            });
                          },
